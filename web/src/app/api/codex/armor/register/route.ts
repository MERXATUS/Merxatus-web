...
import { registerArmorToCodex } from "@/server/armorCodex";
...
export async function POST(req: Request) {
  try {
    ...
    const result = await registerArmorToCodex(
      auth.userId,
      body.data.armorInstanceId,
    ...
    console.error("[api/codex/armor/register]", e);
